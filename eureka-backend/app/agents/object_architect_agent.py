...
{{
  ...
  "components": [
    {{
      ...
      "layout": null or {{
        "type": "radial_array" | "linear_array" | "mirror",
        ... layout-specific parameters (see LAYOUT TYPES below)
      }},
...
LAYOUT TYPES — use these to define RELATIONSHIPS and duplicate parts symmetrically:
  • radial_array: {{ "type": "radial_array", "count": n, "radius": r, "center": [x,y,z], "axis": "X" | "Y" | "Z" }} — repeats parts in a circle around an axis. Used for fan/turbine blades, drone arms, propeller blades, flange bolts.
  • linear_array: {{ "type": "linear_array", "count": n, "spacing": [dx,dy,dz], "start": [x,y,z] }} — spaces parts evenly along a line. Used for engine block cylinder bores, pistons, fins, cooling ribs, bolt patterns.
  • mirror:       {{ "type": "mirror", "axis": "X" | "Y" | "Z" }} — duplicates parts symmetrically across coordinate planes (e.g. wings, mounts, symmetrical support arms).
        ...
        # --- DRONE PRESET ---
            ...
            components = [
                ...
                ObjectComponent(
                    ...
                    parentId="chassis",
                    scaleLevel="subcomponent",
                    function="Rigid support arm connecting chassis to motor.",
                    material="Aluminum Alloy",
                    riskIfRemoved="Propeller drops, asymmetric thrust causes immediate tumble.",
                    position=[0.0, 0.0, 0.0],
                    color="#7f8c8d",
                    geometry={"type": "cylinder", "radius": 0.08, "depth": 0.8},
                    layout={"type": "radial_array", "count": 4, "radius": 0.8, "center": [0.0, 0.0, 0.0], "axis": "Y"},
                    children=["motor"],
                ...
                ObjectComponent(
                    ...
                    riskIfRemoved="No lift generation.",
        ...
        # --- CAR ENGINE PRESET ---
            ...
            components = [
                ...
                ObjectComponent(
                    ...
                    children=["cylinder_head", "oil_pan", "crankshaft", "piston",
                ...
                # --- PISTONS & CONNECTING RODS (Linear Array layout!) ---
                ObjectComponent(
                    id="piston",
                    name="Pistons",
                    parentId="engine_block",
                    scaleLevel="subcomponent",
                    function="Forged aluminum pistons reciprocating in cylinder bores, compressing air-fuel mixture and transmitting combustion force.",
                    material="Aluminum Alloy",
                    riskIfRemoved="Cylinder dead — 25% power loss, severe vibration imbalance.",
                    position=[0.0, 0.08, 0.0],
                    color="#c0c5ce",
                    geometry={"type": "cylinder", "radius": 0.044, "depth": 0.065},
                    layout={"type": "linear_array", "count": 4, "start": [-0.2, 0.0, 0.0], "spacing": [0.13, 0.0, 0.0]},
                    children=["connecting_rod"],
                ...
                ObjectComponent(
                    ...
                    parentId="piston",
                    scaleLevel="subcomponent",
                    function="Forged steel rods linking pistons to crankshaft crank throws, converting linear reciprocation to rotation.",
                    material="Forged Steel",
                    riskIfRemoved="Piston disconnected from crankshaft — thrown rod destroys engine.",
                    position=[0.0, -0.12, 0.0],
                    color="#71797e",
